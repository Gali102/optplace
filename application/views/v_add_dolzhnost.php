	...
	<div class="row">
		...
		<div class="col-md-12">
			...
			<form action='' method='POST'>
				<table class='div-margin-top table table-condensed table-striped table-hover'>
					<thead class='thead-color' >
						<tr>
							<th class="col-md-9 text-center">Название должности</th>
							<th class="col-md-3 text-center"></th>
						</tr>
					</thead>
					<tbody>
						<tr>
							<td class="col-md-9"><?php echo create_input_for_filter('dolzhnost_name',""); ?></td>
							<td class="col-md-3"><button type='submit' name='add_dol' value='true' class='btn btn-success center-block'><i class='icon icon-ok icon-white'></i>Добавить</button></td>
						</tr>
					</tbody>
				</table>
			</form>
			<table class='div-margin-top table table-condensed table-striped table-hover'>
				<thead class='thead-color'>
					<tr>
						<th class="col-md-6 text-center">Название должности</th>
					</tr>
				</thead>
				<tbody>
					<?php foreach ($dolzhnost_name as $items) { ?>
					<tr>
						<td class="col-md-12 text-center"><?php echo $items['dolzhnost_name']; ?></td>
					</tr>
					<?php } ?>
				</tbody>
			</table>
			<?php if (! $dolzhnost_name) { ?>
