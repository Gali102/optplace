...
class Users extends CI_Controller {
	...
	function index() {
		...
		//$data['btn_click_delete'] = $this->func->delete_user($user_id);
		...
		if ($this->form_validation->run()) {
			...
			//$data['users'] = $this->func->delete_user($user_id);
	...
	function change_pass() {
		...
		$user_pass = $this->s_post('user_pass');
		echo $this->func->change_pass($user_id,$user_pass);
	}

	function delete_user() {
		//$user_id = $this->s_post('user_id');
		//$user_pass = $this->s_post('user_pass');
		echo $this->func->delete_user($user_id);
	}
