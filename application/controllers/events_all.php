...
class Events_all extends CI_Controller {
	...
	function index() { 
		...
		$this->func->qn("UPDATE users SET events_all_view = '" . date('Y-m-d H:i:s') . "' where user_id = '$user_id'");
		...
		$res = $this->s_pagination('events_all/index',$this->func->count_all_events($data['user_names'],$data['events_status']),15,3,'?'.http_build_query($_GET));
		$data['pag_links'] = $res['pag_links'];

		$data['events1'] = $this->func->select_events_all_1($user_id,$user_id1,$events_status_id1,$finished_id1,$res['limit'],$res['offset']);
		$data['events2'] = $this->func->select_events_all_2($user_id,$user_id1,$events_status_id1,$finished_id1,$res['limit'],$res['offset']);
		$data['events3'] = $this->func->select_events_all_3($user_id,$user_id1,$events_status_id1,$finished_id1,$res['limit'],$res['offset']);
		$data['events4'] = $this->func->select_events_all_4($user_id,$user_id1,$events_status_id1,$finished_id1,$res['limit'],$res['offset']);
		$data['events5'] = $this->func->select_events_all_5($user_id,$user_id1,$events_status_id1,$finished_id1,$res['limit'],$res['offset']);
		$data['events6'] = $this->func->select_events_all_6($user_id,$user_id1,$events_status_id1,$finished_id1,$res['limit'],$res['offset']);
		
		$data['p_events1'] = $this->func->select_events_all_1($user_id,$user_id1,$events_status_id1,$finished_id1,0,0);
		$data['p_events2'] = $this->func->select_events_all_2($user_id,$user_id1,$events_status_id1,$finished_id1,0,0);
		$data['p_events3'] = $this->func->select_events_all_3($user_id,$user_id1,$events_status_id1,$finished_id1,0,0);
		$data['p_events4'] = $this->func->select_events_all_4($user_id,$user_id1,$events_status_id1,$finished_id1,0,0);
		$data['p_events5'] = $this->func->select_events_all_5($user_id,$user_id1,$events_status_id1,$finished_id1,0,0);
		$data['p_events6'] = $this->func->select_events_all_6($user_id,$user_id1,$events_status_id1,$finished_id1,0,0);
				
		for($i = 1; $i <= 6; $i++) {
			$res = $this->s_pagination('events_all/index',count($data['p_events' . $i]),15,3,'?'.http_build_query($_GET));
		...
		$this->load->view('v_events_all',$data);
